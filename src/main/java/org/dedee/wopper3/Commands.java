...
public class Commands {
	...
	private HashMap<Character, Cmd> nameMap;
	private HashMap<Integer, Character> nameMapReverse;
	...
	private Commands() {
		...
		nameMap = new HashMap<Character, Cmd>();
		...
		nameMapReverse = new HashMap<Integer, Character>();
