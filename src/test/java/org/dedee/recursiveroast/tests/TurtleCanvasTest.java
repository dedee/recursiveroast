...
import org.dedee.recursiveroast.ui.TurtleCanvas;
import org.dedee.recursiveroast.ui.LSystemTurtleModel;
...
public class TurtleCanvasTest {
    public static void main(String[] args) throws Exception {
        ...
        TurtleCanvas canvas = new TurtleCanvas(new LSystemTurtleModel() {
            @Override
